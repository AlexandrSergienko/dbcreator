...
/**
 * Helper for building selection clauses for {@link android.database.sqlite.SQLiteDatabase}. Each appended clause is combined using
 * {@code AND}. This class is <em>not</em> thread safe.
 */
public class SelectionBuilder {

    private static final String DEBUG_TAG = "SelectionBuilder";
    ...
    public Cursor query(SQLiteDatabase db, String[] columns, String groupBy, String having, String orderBy,
        ...
        if (LOGV) {
            Log.v(DEBUG_TAG, "query(columns=" + Arrays.toString(columns) + ") " + this);
        }
